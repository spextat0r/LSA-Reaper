...
if __name__ == '__main__':
    ...
    parser.add_argument('-timeout', action='store', type=int, default=15, help='Set the timeout in seconds for each thread default=15 (WARNING atexec requires a ~8 second minumum)')
